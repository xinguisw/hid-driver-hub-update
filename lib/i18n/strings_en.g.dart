...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'backlight.colorCode' => 'Color code',
			...
			'backlight.modes.multiColor' => 'Multi color',
			'backlight.modes.runningColor' => 'Running color',
			'backlight.modes.cycleWave' => 'Cycle wave',
			...
			'actions.capsLock' => 'Caps Lock',
			'actions.space' => 'Space',
			'actions.enter' => 'Enter',
			'actions.esc' => 'Esc',
			'actions.backspace' => 'Backspace',
			'actions.tab' => 'Tab',
			'actions.insert' => 'Insert',
			'actions.home' => 'Home',
			'actions.pageUp' => 'Page Up',
			'actions.pageDown' => 'Page Down',
			'actions.delete' => 'Delete',
			'actions.end' => 'End',
			'actions.upArrow' => 'Up Arrow',
			'actions.downArrow' => 'Down Arrow',
			'actions.leftArrow' => 'Left Arrow',
			'actions.rightArrow' => 'Right Arrow',
			'actions.printScreen' => 'Print Screen',
			'actions.scrollLock' => 'Scroll Lock',
			'actions.pause' => 'Pause',
			'actions.numLock' => 'Num Lock',
			'actions.numpadEnter' => 'Numpad Enter',
			'actions.numpadDel' => 'Numpad Del',
			'actions.numpadAdd' => 'Numpad +',
			'actions.numpadSub' => 'Numpad -',
			'actions.numpadMul' => 'Numpad *',
			'actions.numpadDiv' => 'Numpad /',
			'actions.numpadEq' => 'Numpad =',
			'actions.numpad0' => 'Numpad 0',
			'actions.numpad1' => 'Numpad 1',
			'actions.numpad2' => 'Numpad 2',
			'actions.numpad3' => 'Numpad 3',
			'actions.numpad4' => 'Numpad 4',
			'actions.numpad5' => 'Numpad 5',
			'actions.numpad6' => 'Numpad 6',
			'actions.numpad7' => 'Numpad 7',
			'actions.numpad8' => 'Numpad 8',
			'actions.numpad9' => 'Numpad 9',
			...
			'macro.actionCountRange' => 'Macro must contain between 1 and 30 actions',
			'macro.delayRange' => ({required Object index}) => 'Action ${index} delay must be between 0 and 127',
			'macro.unsupportedKey' => ({required Object index}) => 'Action ${index} has an unsupported key code',
