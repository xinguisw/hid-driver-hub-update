...
void main() {
  group('MouseProtocol.validateConfigAckFrame', () {
    test('B2 desktop length + addrs OK', () {
      expect(
        () => MouseProtocol.validateConfigAckFrame(_b2Desktop(), addrs: 0xB2),
        returnsNormally,
      );
    });
    ...
    test('short body throws', () {
      expect(
        () => MouseProtocol.validateConfigAckFrame(Uint8List(8), addrs: 0xB2),
    ...
    test('wrong addrs throws', () {
      expect(
        () => MouseProtocol.validateConfigAckFrame(_b2Desktop(), addrs: 0xC2),
        throwsA(isA<CodecException>()),
      );
    });
